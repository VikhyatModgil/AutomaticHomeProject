...
function start() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            ...
            mqttServiceWorker = mqtt.connect(config_1["default"].mqttURL);
            return [2 /*return*/, mqtt];
        });
    });
}
function publish(_, _a) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _b.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, mqttServiceWorker.publish(topic, message)];
                case 2:
                    _b.sent();
